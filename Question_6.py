...
#working out one cell division mRNA in betweeen the two values
x=m_store[div_index[0]:div_index[1]]
...
plt.title('Gillespie simulation of [mRNA] in cell division when K0 varies')
# show a legend on the plot
# Display a figure.
plt.show()

del m_store[0:div_index[0]]
mean= np.mean(m_store) #working out the total one cell division mRNA 
var= np.var(m_store)
fano= (var/mean)
print(mean)
